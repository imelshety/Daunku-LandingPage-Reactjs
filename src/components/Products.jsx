        ...
        >
            <FadeIn delay={0.2} direction="right">
                <div className="flex flex-col">
                    <h1 className="text-center 2xl:text-start text-fontBlack text-5xl lg:text-[64px] font-medium mb-6">Best Seller Product</h1>
                    <button
                ...
                <FadeIn delay={0.2} direction="left" fullWidth>
                    <div className="h-[510px] relative flex-1 bg-[#C1D0E4] rounded-[50px] max-w-[500px]">
                        ...
                        <div className="flex justify-between items-center">
                            <h3 className="text-fontBlack text-2xl lg:text-3xl font-medium absolute bottom-2 left-4">
                                $65.00
                            </h3>
                            <img
                                src={plusIcon}
                                alt=""
                                className="cursor-pointer h-10 xs:h-12 w-10 xs:w-12 absolute bottom-2 right-2 "
                            />
                        </div>
                    </div>
                </FadeIn>
